...
Working name for the proposed project: `vibe-talk`. Research checked 2026-08-18 against project
...
| --- | --- | --- | --- | --- | --- |
| Proposed `vibe-talk` server | Yes (to be built) | Yes | Yes | Partial (phone screen) | Whole server |
