...
URL. Wrkslots records a SHA-256 identity for that URL and requires it to remain unchanged through
handoff and removal; callers do not repeat the URL on the command line.
